...
Useful software often comes out of frustration. When a programmer finds themselves wandering for a tool or a library that doesn’t exist yet, they may decide to write it. At least, they know it would be useful for one user, themself, aside from the fun time spent coding. In my case, I needed an easy way to navigate my ebook notes, and all I could find were subscription based services that didn’t fit my casual use. This is how [**Liture**](https://liture.co/) started.

> “Readers eat books. Film eats viewers.”
> — *The Wave in the Mind*, Ursula K. Le Guin

I’ve read a lot of books recently, compared to what I used to read a few years ago, and I do most of my readings with an ebook reader. I love printed books. I miss the feeling that touching paper gives, the visual feedback of the progress, the different style for covers and typography used for each book. I still buy physical copies and often second-hand, but I prefer to read in Italian[^1], my original language, and since I'm in Australia, far from Italian bookshops and I don’t want to pollute the planet with my hobbies, I started to read digital books. With time I got used to the e-ink screen, to read in the dark thanks to the backlights, to be able to carry hundreds of books in my pocket. Today it has become one of those few device that I cannot live without.

I also got into the habit of highlighting the books and sometimes taking annotations, which is kind of easy using an e-reader.  Soon my collection of quotes and notes grown. For some books, like [_21 Lessons for the 21st Century_](https://www.goodreads.com/book/show/38820046-21-lessons-for-the-21st-century), I had to print my highlights to review them, filling around 15 pages, and then re-highlight the most important parts. Even if I find paper more effective for focus reading then digital text, I become frustrated every time I had to review my highlights and notes from an ebook, since there’s no nice way to access that data. 

I use a Kobo reader and all the content that the user generate is stored inside the device. Export is not officially supported. A few years ago I started maintaining [a python script]([https://github.com/eliascotto/export-kobo](https://github.com/eliascotto/export-kobo)) that extract highlights and notes in different formats, but with a lot of notes it stopped being practical. I needed a way to **search** my *highlights* and *notes*, to **save** my favourite quotes, to see them grouped by author and book. Also highlighting as well as typing on an e-reader is not that precise, the devices are usually quite slow to respond, so I ended up having a lot of errors and imperfection to fix. I want to edit my content, and also add new notes to enrich it. I needed a new kind of software for this.
